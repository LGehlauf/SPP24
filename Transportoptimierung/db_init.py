def db_init():
    ...
    cursor.execute('INSERT INTO produktstammdaten (id, bezeichnung, dlz_plan, losgroesse, bestand_rtl, bestand_ftl, bestellbestand) VALUES (?, ?, ?, ?, ?, ?, ?)', 
                ('A1', 'Gehause', '50', '5', '700', '140', '150'))
    cursor.execute('INSERT INTO produktstammdaten (id, bezeichnung, dlz_plan, losgroesse, bestand_rtl, bestand_ftl, bestellbestand) VALUES (?, ?, ?, ?, ?, ?, ?)', 
                ('A2', 'Deckel', '150', '20', '400', '170', '250'))
    cursor.execute('INSERT INTO produktstammdaten (id, bezeichnung, dlz_plan, losgroesse, bestand_rtl, bestand_ftl, bestellbestand) VALUES (?, ?, ?, ?, ?, ?, ?)', 
                ('A3', 'Zylinderrohr', '100', '35', '330', '310', '250'))
    cursor.execute('INSERT INTO produktstammdaten (id, bezeichnung, dlz_plan, losgroesse, bestand_rtl, bestand_ftl, bestellbestand) VALUES (?, ?, ?, ?, ?, ?, ?)', 
                ('A4', 'Zylinderboden', '200', '35', '530', '70', '300'))
    cursor.execute('INSERT INTO produktstammdaten (id, bezeichnung, dlz_plan, losgroesse, bestand_rtl, bestand_ftl, bestellbestand) VALUES (?, ?, ?, ?, ?, ?, ?)', 
                ('A5', 'Kolbenstange', '200', '20', '530', '230', '190'))
    cursor.execute('INSERT INTO produktstammdaten (id, bezeichnung, dlz_plan, losgroesse, bestand_rtl, bestand_ftl, bestellbestand) VALUES (?, ?, ?, ?, ?, ?, ?)', 
                ('A6', 'Zahnrad', '200', '40', '530', '230', '500'))
    cursor.execute('INSERT INTO produktstammdaten (id, bezeichnung, dlz_plan, losgroesse, bestand_rtl, bestand_ftl, bestellbestand) VALUES (?, ?, ?, ?, ?, ?, ?)', 
                ('A7', 'Welle', '200', '8', '530', '190', '150'))
    cursor.execute('INSERT INTO produktstammdaten (id, bezeichnung, dlz_plan, losgroesse, bestand_rtl, bestand_ftl, bestellbestand) VALUES (?, ?, ?, ?, ?, ?, ?)', 
                ('A8', 'Kolben', '200', '40', '330', '310', '250'))
    ...
    # FFZ
    cursor.execute('INSERT INTO ffz (id, speed, akkukapazitaet) VALUES (?, ?, ?)', ('F1', '0.7', '2000'))
    cursor.execute('INSERT INTO ffz (id, speed, akkukapazitaet) VALUES (?, ?, ?)', ('F2', '0.9', '1500'))
    cursor.execute('INSERT INTO ffz (id, speed, akkukapazitaet) VALUES (?, ?, ?)', ('F3', '1.1', '1300'))
